     ...
     <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
            <div className='flex flex-col gap-4 flex-1'>
              ...
              type='text'
               ...
               id='name'
               maxLength={'62'} minLength={'4'}  required
              ...
              type='text'
               ...
               <div className="flex flex-wrap gap-6">
                <div className="flex items-center gap-2">
                  ...
                  className='p-3 border border-gray-300'onChange={handleChange} value={formData.bedrooms} />
                  <p>Bedrooms</p>
                </div>
                <div className='flex items-center gap-2'>
              <input
            ...
            hover:opacity-95 disabled:opacity-80'>Create Your List</button>
